               ...
               <div class="col-12 col-lg-8">
                    ...
                    <div class="card border-0 bg-white shadow-lg">
                         <div class="card-header">
                              <h5 class="card-title mb-0 font-weight-bold">Create New Post</h5>
                         </div>
                         <form action="{{ route('post.store') }}" method="POST" enctype="multipart/form-data">
                              ...
                              <div class="card-body">
                                   <div class="form-group">
                                        ...
                                        <input type="text" class="form-control rounded-0 @error('post_title') is-invalid @enderror" name="post_title" id="post_title" value="{{ old('post_title') }}">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <input type="text" class="form-control rounded-0 @error('post_excerpt') is-invalid @enderror" name="post_excerpt" id="post_excerpt" value="{{ old('post_excerpt') }}">
                                        @error('post_excerpt') <span class="text-danger">{{ $message }}</span>@enderror
                                   </div>
                                   <div class="form-group">
                                        <label for="post_description">Post Description : </label>
                                        <textarea name="post_description" id="post_description" rows="10" class="form-control rounded-0 @error('post_description') is-invalid @enderror">{{ old('post_description') }}</textarea>
